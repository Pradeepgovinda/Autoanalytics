                  ...
                  <div className="col items">
                    ...
                    <div className="row">
                      <div className="col">
                        ...
                        <span className="item-model"><br />Name: {item.age}<br />Stock: {item.stock} </span>
                      </div>
                      <div className="col">
                        <span className="item-sell">Days: {item.calc}<br />  </span>
                        <span className="item-price">Price: {item.cost}</span>
                      </div>
                    </div>
                  </div>
                </div>
...
//       "https://powerbi.approcket.in/api/v1/report"
//     );
//     const products = data;
